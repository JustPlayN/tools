...
var getUrlParam = function (name, url) {
    var search = url || decodeURIComponent(window.location.search);
    var reg = new RegExp('(^|&)' + name + '=([^&]*)(&|$)');
...
var callPhone = function (phone) {
    isApp() ? appApi('callPhone', [phone]) : window.location.href = phone;
};
var login = function () {
...
var index$1 = __assign({}, tools, sdkApi, utils);
...
var script = {
  data () {
    return {
      ios: index$1.isIos(),
      app: index$1.isApp(),
      number: index$1.accMul(1.2, 1.2)
    }
  },
  methods: {
    testThrottle: index$1.throttle(function () {
      this.mylog();
    }),
    mylog () {
      console.log(this);
  ...
  created () {
    console.log(index$1.getUrlParam('id'));
  }
};
...
var __vue_render__ = function() {
  ...
  return _c("div", { staticClass: "example" }, [
    _c("div", [_vm._v("isIos: " + _vm._s(_vm.ios))]),
    _vm._v(" "),
    _c("div", [_vm._v("isApp: " + _vm._s(_vm.app))]),
    _vm._v(" "),
    _c("div", [_vm._v("isAlipay: " + _vm._s(_vm.app))]),
    _vm._v(" "),
...
if (window.navigator.userAgent.toLowerCase().indexOf('micromessenger') !== -1) {
    loadJs$1('https://res.wx.qq.com/open/js/jweixin-1.3.2.js');
}
